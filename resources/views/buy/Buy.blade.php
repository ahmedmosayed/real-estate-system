...
<form id="header-bottom-bottom" method="POST" action="BuyFilter">
    @csrf
...
<section class="filterb">
    <div class="filter" >
      ...
      <section class="property" id="property">
        <div class="container">
          <p class="section-subtitle">For Sale</p>
          <h2 class="h2 section-title">Properties For Sale</h2>
  ...
  <div class="card-footer">
    ...
    <div class="card-author">
      ...
      <figure class="author-avatar">
        <img @if ($P->PropertyPublisher->UserProfileInfo->ProfileImg ??'') src="{{asset('ProfileImages/'.$P->PropertyPublisher->UserProfileInfo->ProfileImg)}}" @else src ="{{asset('AltPhotos/Person.jpg')}}"@endif alt="William Seklo" class="w-100">
      </figure>
          ...
          <ul class="service-list">
            ...
            <li>
              <div class="service-card">
                ...
                <div class="card-icon">
                  <a href="BuyPage"> <img src="./assets/images/service-2.png" alt="Service icon"></a>
                </div>
            ...
            <li>
              <div class="service-card">
                ...
                <div class="card-icon">
                  <a href="Rent.html"> <img src="./assets/images/service-2.png" alt="Service icon"></a>
                </div>
